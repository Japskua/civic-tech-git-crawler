...
| **Total commits (repo_metrics)** | 10,966 |
...
| HHI (humans only, 0–10,000) | 2,151.80 |
| Effort Gini on lines changed | 0.81 |
| Effort Gini on commits | 0.78 |
| Top contributor | `kelvinkipruto` |
| Top contributor's lines share | 29.0% |
| Mean weekly top-contributor share | 71.8% |
| % weeks dominated by one contributor (≥50%) | 80.1% |
| % solo weeks (≥99.9% from one person) | 16.5% |
| Lines added / removed | 4,601,514 / 3,083,980 |
| Net LOC delta | 1,517,534 |
| Overall churn ratio | 0.40 |
| Community profile (health %) | 37 |
| Issues (total / open / closed) | 443 / 51 / 392 |
| Median issue first response (h) | 12.10 |
| Median PR review turnaround (h) | 1 |
| Change-request acceptance ratio | 0.83 |
| Stale issue ratio | 0.76 |
