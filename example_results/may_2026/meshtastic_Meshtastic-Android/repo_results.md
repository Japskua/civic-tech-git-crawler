...
| **Stars / Forks** | 1,585 / 452 |
| **First commit** | 2020-01-20 |
| **Project age** | 6.4 years |
| **Total commits (repo_metrics)** | 6,506 |
| **Attributable contributors (CWA)** | 114 |
...
| HHI (humans only, 0–10,000) | 9,329.40 |
| Effort Gini on lines changed | 0.97 |
| Effort Gini on commits | 0.93 |
| Top contributor | `jamesarich` |
| Top contributor's lines share | 69.8% |
| Mean weekly top-contributor share | 86.4% |
| % weeks dominated by one contributor (≥50%) | 96.6% |
| % solo weeks (≥99.9% from one person) | 33.2% |
| Lines added / removed | 761,354 / 521,385 |
| Net LOC delta | 239,969 |
| Overall churn ratio | 0.41 |
| Community profile (health %) | 100 |
| Issues (total / open / closed) | 1,474 / 39 / 1,435 |
| Median issue first response (h) | 1.40 |
| Median PR review turnaround (h) | 0.40 |
| Change-request acceptance ratio | 0.92 |
| Stale issue ratio | 0.36 |


## Things to note

- **Extreme effort concentration** (HHI 9,329 on a 0–10,000 scale, bus factor 1). Removing the top contributor would substantially halt activity.
