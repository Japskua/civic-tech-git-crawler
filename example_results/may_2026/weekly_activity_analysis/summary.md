...
- `mastodon/mastodon`: mean top-share 62.2%, 63% of weeks ≥50%, 4% solo
- `meshtastic/firmware`: mean top-share 65.2%, 72% of weeks ≥50%, 7% solo

**Dataset-wide**: weighted by weeks, 83% of active weeks had a single contributor responsible for ≥50% of the code change.
...
- `DemocracyClub/UK-Polling-Stations`: +6,297,063 / −9,733,304 → net -3,436,241 lines, overall churn 0.61
...
- `meshtastic/Meshtastic-Android`: Gini(lines) 0.97, Gini(commits) 0.93, top contributor `jamesarich` did 70%
