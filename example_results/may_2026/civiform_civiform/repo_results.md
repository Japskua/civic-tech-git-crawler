...
| **Total commits (repo_metrics)** | 7,799 |
...
| HHI (humans only, 0–10,000) | 1,486.40 |
| Effort Gini on lines changed | 0.74 |
| Effort Gini on commits | 0.77 |
| Top contributor | `gwendolyngoetz` |
| Top contributor's lines share | 14.4% |
| Mean weekly top-contributor share | 50.6% |
| % weeks dominated by one contributor (≥50%) | 43.6% |
| % solo weeks (≥99.9% from one person) | 2.9% |
| Lines added / removed | 820,592 / 464,729 |
| Net LOC delta | 355,863 |
| Overall churn ratio | 0.36 |
| Community profile (health %) | 100 |
| Issues (total / open / closed) | 4,409 / 859 / 3,550 |
| Median issue first response (h) | 15.20 |
| Median PR review turnaround (h) | 17.50 |
