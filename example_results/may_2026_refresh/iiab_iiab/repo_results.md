...
| **Stars / Forks** | 1,855 / 131 |
| **First commit** | 2017-05-27 |
| **Project age** | 9.4 years |
| **Total commits (repo_metrics)** | 14,612 |
| **Attributable contributors (CWA)** | 41 |
...
| HHI (humans only, 0–10,000) | 5,431.10 |
| Effort Gini on lines changed | 0.90 |
| Effort Gini on commits | 0.92 |
| Top contributor | `holta` |
| Top contributor's lines share | 70.0% |
| Mean weekly top-contributor share | 86.9% |
| % weeks dominated by one contributor (≥50%) | 97.4% |
| % solo weeks (≥99.9% from one person) | 39.0% |
| Lines added / removed | 339,972 / 200,139 |
| Net LOC delta | 139,833 |
| Overall churn ratio | 0.37 |
| Community profile (health %) | 62 |
| Issues (total / open / closed) | 1,530 / 315 / 1,215 |
| Median issue first response (h) | 2.90 |
| Median PR review turnaround (h) | 2.20 |
