...
| **Total commits (repo_metrics)** | 674 |
...
| % solo weeks (≥99.9% from one person) | 79.8% |
| Lines added / removed | 62,746 / 14,454 |
| Net LOC delta | 48,292 |
| Overall churn ratio | 0.19 |
| Community profile (health %) | 25 |
| Issues (total / open / closed) | 145 / 27 / 118 |
| Median issue first response (h) | 1,005.90 |
| Median PR review turnaround (h) | 27.30 |
| Change-request acceptance ratio | 0.81 |
| Stale issue ratio | 1 |
