...
| HHI (humans only, 0–10,000) | 3,070.70 |
...
| % weeks dominated by one contributor (≥50%) | 94.4% |
| % solo weeks (≥99.9% from one person) | 28.5% |
| Lines added / removed | 6,297,037 / 9,733,304 |
| Net LOC delta | -3,436,267 |
...
- **Net-negative LOC trajectory.** Cumulative deletions (9,733,304) exceed cumulative additions (6,297,037) by 3,436,267 lines over the project's history — consistent with the maintenance phase signal in `analysis_n38.md` §3.9.
