...
| **Total commits (repo_metrics)** | 189 |
...
| HHI (humans only, 0–10,000) | 1,753.60 |
...
| Mean weekly top-contributor share | 90.4% |
| % weeks dominated by one contributor (≥50%) | 95.0% |
| % solo weeks (≥99.9% from one person) | 65.0% |
| Lines added / removed | 10,895 / 3,176 |
| Net LOC delta | 7,719 |
