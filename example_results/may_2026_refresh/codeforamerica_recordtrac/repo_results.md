...
- **Net-negative LOC trajectory.** Cumulative deletions (366,883) exceed cumulative additions (333,219) by 33,664 lines over the project's history — consistent with the maintenance phase signal in `analysis_n38.md` §3.9.
