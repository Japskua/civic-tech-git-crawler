# AI Adoption and Contributor Dynamics in Open-Source Civic Technology: A 57-Project Snapshot (2026-06)

This writeup accompanies the **2026-06 refresh** of the civic-tech corpus (n = 57).
...
57 open-source civic-technology projects across 24 organisations and seven
...
n = 57 these are **exploratory**; AI-usage comparisons in particular are
...
Mature projects (≥ 3.5 yr) have far more developers (median 15.5 vs 3.5, p < 0.001,
large effect) and commits (1,358 vs 189, p < 0.001), and are meaningfully less
...
**24 of 57 projects (42%)** show at least one AI-assisted-development signal. The
...
Comparing adopters (n = 24) against non-adopters (n = 33):
...
Only **2 of 57 projects ship an LLM product feature** (`CodeForAfrica/PromiseTracker`,
...
- **AI-usage detection is a lower bound.** Only disclosed/configured/automated
  ...
  True AI-assistance rates are necessarily *higher* than the 42% reported.
- **Correlational, not causal.** §2.5 comparisons cannot establish direction;
  ...
  forward effect.
- **Small n and dependency-ecosystem bias.** n = 57 limits power; product-LLM
...
technology — **42% of this corpus** carries a durable trace of it, almost entirely
