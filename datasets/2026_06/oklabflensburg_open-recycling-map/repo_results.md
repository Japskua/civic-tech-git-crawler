...
[View on GitHub](https://github.com/oklabflensburg/open-recycling-map)

## At a glance

| | |
|---|---|
| **Repository** | [oklabflensburg/open-recycling-map](https://github.com/oklabflensburg/open-recycling-map) |
| **Primary language** | HTML |
| **Stars / Forks** | 1 / 2 |
| **First commit** | 2023-07-25 |
| **Project age** | 3.4 years |
| **Total commits (repo_metrics)** | 36 |
...
| Lines added / removed | 11,057 / 9,619 |
| Net LOC delta | 1,438 |
