...
[View on GitHub](https://github.com/fvialibre/heseia-sentence-bias-dataset)

## At a glance

| | |
|---|---|
| **Repository** | [fvialibre/heseia-sentence-bias-dataset](https://github.com/fvialibre/heseia-sentence-bias-dataset) |
| **Primary language** | nan |
| **Stars / Forks** | 0 / 0 |
| **First commit** | 2025-05-20 |
| **Project age** | 1.4 years |
| **Total commits (repo_metrics)** | 9 |
...
| Lines added / removed | 80,245 / 65,781 |
| Net LOC delta | 14,464 |
...
- **Low GitHub community-profile score (14%).** Likely missing some of: CONTRIBUTING, CODE_OF_CONDUCT, GOVERNANCE, README, issue/PR templates.
