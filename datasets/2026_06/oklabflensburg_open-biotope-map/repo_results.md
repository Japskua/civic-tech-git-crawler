...
[View on GitHub](https://github.com/oklabflensburg/open-biotope-map)

## At a glance

| | |
|---|---|
| **Repository** | [oklabflensburg/open-biotope-map](https://github.com/oklabflensburg/open-biotope-map) |
| **Primary language** | HTML |
| **Stars / Forks** | 1 / 2 |
| **First commit** | 2024-10-08 |
| **Project age** | 2.4 years |
| **Total commits (repo_metrics)** | 62 |
...
| Lines added / removed | 9,043 / 1,500 |
| Net LOC delta | 7,543 |
| Overall churn ratio | 0.14 |
