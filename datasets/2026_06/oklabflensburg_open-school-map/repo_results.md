...
[View on GitHub](https://github.com/oklabflensburg/open-school-map)

## At a glance

| | |
|---|---|
| **Repository** | [oklabflensburg/open-school-map](https://github.com/oklabflensburg/open-school-map) |
| **Primary language** | Vue |
| **Stars / Forks** | 1 / 1 |
| **First commit** | 2024-01-05 |
| **Project age** | 2.4 years |
| **Total commits (repo_metrics)** | 124 |
...
| HHI (humans only, 0–10,000) | 9,840 |
...
| Lines added / removed | 27,771 / 12,275 |
| Net LOC delta | 15,496 |
| Overall churn ratio | 0.31 |
| Community profile (health %) | 62 |
| Issues (total / open / closed) | 1 / 1 / 0 |
...
- **Extreme effort concentration** (HHI 9,840 on a 0–10,000 scale, bus factor 1). Removing the top contributor would substantially halt activity.
