...
- `oklabflensburg/open-emergency-map`: mean top-share 100.0%, 100% of weeks ≥50%, 100% solo
...
- `CodeForAfrica/actNOW`: mean top-share 61.2%, 95% of weeks ≥50%, 10% solo
- `meshtastic/firmware`: mean top-share 65.1%, 72% of weeks ≥50%, 7% solo
- `CivicTechWR/accessible-housing-portal`: mean top-share 70.5%, 80% of weeks ≥50%, 10% solo
...
- `meshtastic/Meshtastic-Android`: Gini(lines) 0.97, Gini(commits) 0.93, top contributor `jamesarich` did 74%
...
- `openlegaldata/oldp`: Gini(lines) 0.92, Gini(commits) 0.85, top contributor `malteos` did 96%
