...
|---|---|---|
| `ai_usage.csv` | 1 row / repo (55) | Per-repo AI-usage summary (§2) |
...
| Measure | Value |
|---|---|
| Repos with AI-assisted development | 24 / 55 (43.6%) |
| Repos shipping an LLM product feature | 2 / 55 (3.6%) |
| Repos with any AI signal | 25 / 55 (45.5%) |
...
(adopters n = 24, non-adopters n = 31)
...
3/9 (33%) · German OK-Lab 3/18 (17%) · Other 2/6 (33%).
...
`analysis_n55.md` (full analysis), `README.md` (dataset overview).*
