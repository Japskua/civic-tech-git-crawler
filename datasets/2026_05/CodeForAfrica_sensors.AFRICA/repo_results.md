...
- **Net-negative LOC trajectory.** Cumulative deletions (403,492) exceed cumulative additions (388,124) by 15,368 lines over the project's history — a maintenance-phase signal (see [`../analysis_n55.md`](../analysis_n55.md)).
