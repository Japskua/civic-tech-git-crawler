...
| **Primary language** | C++ |
| **Stars / Forks** | 7,632 / 2,383 |
| **First commit** | 2020-02-01 |
| **Project age** | 6.4 years |
| **Total commits (repo_metrics)** | 11,910 |
| **Attributable contributors (CWA)** | 437 |
...
| HHI (humans only, 0–10,000) | 1,326.90 |
| Effort Gini on lines changed | 0.96 |
| Effort Gini on commits | 0.91 |
| Top contributor | `caveman99` |
| Top contributor's lines share | 18.6% |
| Mean weekly top-contributor share | 65.1% |
| % weeks dominated by one contributor (≥50%) | 71.7% |
| % solo weeks (≥99.9% from one person) | 7.4% |
| Lines added / removed | 1,490,783 / 762,557 |
| Net LOC delta | 728,226 |
| Overall churn ratio | 0.34 |
| Community profile (health %) | 100 |
| Issues (total / open / closed) | 3,347 / 264 / 3,083 |
| Median issue first response (h) | 0.30 |
