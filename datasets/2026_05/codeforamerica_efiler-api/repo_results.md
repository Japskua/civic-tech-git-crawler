...
| **Total commits (repo_metrics)** | 131 |
...
| Top contributor's lines share | 57.9% |
| Mean weekly top-contributor share | 86.0% |
| % weeks dominated by one contributor (≥50%) | 100.0% |
| % solo weeks (≥99.9% from one person) | 39.1% |
| Lines added / removed | 5,958 / 2,244 |
| Net LOC delta | 3,714 |
| Overall churn ratio | 0.27 |
| Community profile (health %) | 50 |
| Issues (total / open / closed) | 0 / 0 / 0 |
| Median issue first response (h) | — |
| Median PR review turnaround (h) | 19.20 |
| Change-request acceptance ratio | 0.69 |
| Stale issue ratio | — |
