...
| **Total commits (repo_metrics)** | 266 |
...
| Top contributor's lines share | 47.2% |
| Mean weekly top-contributor share | 89.4% |
| % weeks dominated by one contributor (≥50%) | 95.2% |
| % solo weeks (≥99.9% from one person) | 52.4% |
| Lines added / removed | 19,231 / 7,076 |
...
| Median PR review turnaround (h) | 1.60 |
