...
| **Total commits (repo_metrics)** | 1,349 |
...
| HHI (humans only, 0–10,000) | 6,081.90 |
...
| % weeks dominated by one contributor (≥50%) | 91.0% |
| % solo weeks (≥99.9% from one person) | 24.0% |
| Lines added / removed | 69,836 / 34,415 |
...
| Median PR review turnaround (h) | 5.50 |
